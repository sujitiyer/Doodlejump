...
/** @deprecated version of create_drag
 * 
*/
...
/**
 * Adds a force creator to a scene that causes a body to move horiztonally
 * back and forth
 * 
 * @param scene the scene containing the body
 * @param window the dimensions of the window of display
 * @param speed the speed at which to move the body
 * @param buffer the minimum distance between the body centroid and the edge
...
/**
 * Adds a force creator to a scene that applies a constant downward
 * acceleration to a single body
 * 
 * @param scene the scene containing the bodies
 * @param G the acceleration
 * @param body the body to be accelerated
*/
