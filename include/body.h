...
/**
 * Returns the image associated with a body
 * 
 * @param body the body to get the image of
 * @return a pointer to the image struct associated with a body
*/
 ...
 * 
 * @param body a pointer to the body who's info needs setting
 * @param info the new info for the body
*/
 ...
 *
 * @param body a pointer to a body returned from body_init()
 * @param color an rgb color to set the body to
 */
