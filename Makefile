...
STUDENT_LIBS = list vector polygon body forces collision scene sprite text image

STUDENT_LIBS_TEMP = body scene forces
...
TEST_BINS = $(addprefix bin/test_suite_,$(STUDENT_LIBS_TEMP))
